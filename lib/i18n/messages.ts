...
export const MESSAGES = {
  en: {
    ...
    "contact.contentTitle": "Let's connect",
    "contact.contentBody":
      "Whether you want to collaborate, host an event together, or simply chat about the bear community — drop us a line. We read every message and aim to reply within 48 hours.",
    "contact.emailLabel": "Email us directly",
    "contact.emailValue": "hello@bearhood.de",
    ...
    "contact.formSubjectPlaceholder": "What is this about?",
    "contact.formMessage": "Message",
    "contact.formMessagePlaceholder": "Tell us more…",
    "contact.formSubmit": "Send message",
    "contact.formSubmitting": "Sending…",
    "contact.formSuccess": "Message sent! We will get back to you soon.",
    "contact.formError": "Could not send your message. Please try again.",
    "contact.formRequired": "Please fill in all fields.",
    ...
    "gallery.pageDescription": "Browse photos from our past events.",
    "gallery.photos": "photos",
    "gallery.backToGallery": "Back to Gallery",
    "gallery.requestRemoval": "Request Removal",
    "gallery.removalRequested": "Requested",
    "gallery.removalDescription": "Your removal request has been submitted. We'll review it shortly.",
    "gallery.signInToRequest": "Sign in to request removal",
    "gallery.imageId": "Image ID",
  ...
  de: {
    ...
    "contact.pageDescription":
      "Hast du eine Frage, eine Idee oder möchtest einfach Hallo sagen? Wir freuen uns von dir zu hören.",
    "contact.contentTitle": "Lass uns vernetzen",
    "contact.contentBody":
      "Ob du mit uns zusammenarbeiten, gemeinsam ein Event veranstalten oder einfach über die Bear-Community plaudern willst — schreib uns. Wir lesen jede Nachricht und antworten in der Regel innerhalb von 48 Stunden.",
    "contact.emailLabel": "Schreib uns direkt",
    "contact.emailValue": "hello@bearhood.de",
    "contact.socialLabel": "Folge uns",
    "contact.formName": "Name",
    "contact.formNamePlaceholder": "Dein Name",
    "contact.formEmail": "E-Mail",
    "contact.formEmailPlaceholder": "du@beispiel.de",
    "contact.formSubject": "Betreff",
    "contact.formSubjectPlaceholder": "Worum geht es?",
    "contact.formMessage": "Nachricht",
    "contact.formMessagePlaceholder": "Erzähl uns mehr…",
    "contact.formSubmit": "Nachricht senden",
    "contact.formSubmitting": "Wird gesendet…",
    "contact.formSuccess": "Nachricht gesendet! Wir melden uns bald bei dir.",
    "contact.formError": "Nachricht konnte nicht gesendet werden. Bitte erneut versuchen.",
    "contact.formRequired": "Bitte fülle alle Felder aus.",
    ...
    "gallery.pageDescription": "Durchstöbere Fotos unserer vergangenen Events.",
    "gallery.photos": "Fotos",
    "gallery.backToGallery": "Zurück zur Galerie",
    "gallery.requestRemoval": "Entfernung anfordern",
    "gallery.removalRequested": "Angefordert",
    "gallery.removalDescription": "Deine Entfernungsanfrage wurde eingereicht. Wir prüfen sie in Kürze.",
    "gallery.signInToRequest": "Melde dich an, um eine Entfernung anzufordern",
    "gallery.imageId": "Bild-ID",
    "gallery.previousImage": "Vorheriges Bild",
    "gallery.nextImage": "Nächstes Bild",
    "gallery.closeLightbox": "Schließen",
  },
