/**
 * Brand mark SVGs: Instagram, Facebook, Eventbrite from Simple Icons (CC0 1.0).
 * Resident Advisor uses a text monogram (no official icon in Simple Icons set).
 */
...
export function EventbriteIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className ?? iconClass}
      viewBox="0 0 24 24"
...
/** Resident Advisor (ra.co) — text monogram; no Simple Icons glyph available. */
export function ResidentAdvisorIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className ?? iconClass}
      viewBox="0 0 24 24"
